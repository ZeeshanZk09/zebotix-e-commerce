        ...
        >
          ...
          >
            ...
            <div className='mb-4'>
              ...
              <p>
                <span className='text-green-700'>Paid:</span> {selectedOrder.isPaid ? 'Yes' : 'No'}
              </p>
              ...
              <p>
                <span className='text-green-700'>Status:</span> {selectedOrder.status}
              </p>
              <p>
                <span className='text-green-700'>Order Date:</span>{' '}
                {new Date(selectedOrder.createdAt as Date).toLocaleString()}
              </p>
            </div>
